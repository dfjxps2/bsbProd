...
dataProcessor.wrap = function(name, before, after) {
    ...
    d[name] = function() {
        ...
        if (after)
            after.apply(this, [arguments, res]);
        return res
    }
};
