 ...
 */
Ext.PagingToolbar3 = Ext.extend(Ext.Toolbar, {
    /**
    ...
    initComponent : function(){
        Ext.PagingToolbar3.superclass.initComponent.call(this);
        this.cursor = 0;
    ...
    onRender : function(ct, position){
        Ext.PagingToolbar3.superclass.onRender.call(this, ct, position);
    ...
    doLoad : function(start){
        ...
        formSubmit(this.start,this.limit); 
...
Ext.reg('paging', Ext.PagingToolbar3);