...
Ext.MyPagingToolbar = Ext.extend(Ext.Toolbar, {
        ...
        if(this.displayItem){
            ...
            var msg = count == 0 ?
                ...
                String.format(
                    this.displayMsg,
                    this.cursor+1,
                    this.cursor+(count-this.cursor<this.limit?count-this.cursor:this.limit),
                    count
                );
    ...
    changePage : function(page){
        this.doLoad(((page-1) * this.pageSize).constrain(0, this.totalCount));
    },
    ...
    doLoad : function(start){
        this.start = start;
        var path = this.filePath + '&start='+this.start+'&limit='+this.limit;
        load(path,true);
        this.onLoad(this);
    },
