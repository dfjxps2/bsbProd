...
Ext.onReady(function() {
	...
	var rnode = getRootNode('root', '私有指标树', expandMyMeasureTreeNode);
	rnode.attributes.is_private = 'Y';
		...
		listeners : {
			click : function(node) {
				...
				propertyPanel.form.load({
					url : pathUrl + '/privateMeasure_common.action?method=getEngMeasureById&measure_id='+node.id
				});
			}
		},
