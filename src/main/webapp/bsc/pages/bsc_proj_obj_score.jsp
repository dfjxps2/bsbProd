...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			var totalCount = 0;
			var dhtmlGrid = null;
			var monthID = '${param.month_id}',projectID = '${param.project_id}',
				monthName='${param.monthName}',projectName='${param.projectName}',
				cycle_type_id = '${param.cycle_type_id}';
			var objCateId = '${param.objCateId}';
	    </script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/bsc/scripts/bsc_proj_obj_score_layout.js"></script>
	</head>
  
  	<body>
	  	<!-- 导出Excel文件Form -->
	  	<form id="excelForm" name="excelForm" action="bscresult_exportScore.action" method="post" target="">
