...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		Ext.QuickTips.init();
		var height,width;
		var projectID="${param.project_id}",roleID="${param.role_id}",published="${param.published}",monthID = "${param.month_id}",objectID = "${param.object_id}";
    </script>
	
	<script type="text/javascript" src="${pageContext.request.contextPath}/bsc/scripts/bsc_result_detail"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/bsc/scripts/bsc_result_detail_layout.js"></script>
	
  </head>
  
  <body>
  	<!-- 导出Excel文件Form -->
  	<form id="excelForm" name="excelForm" action="bscresult_exportDetail.action" method="get" target="">
