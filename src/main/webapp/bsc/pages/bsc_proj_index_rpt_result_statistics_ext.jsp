	...
	<head>
		...
		<script type="text/javascript">
			...
			var monthID = '${param.month_id}',projectID = '${param.project_id}',measure_id = '${param.measure_id}',
				...
				cycle_type_id = '${param.cycle_type_id}', zoneID = '';
			var objCateId = '${param.objCateId}';
			var showID = '${param.show_id}',objID = '${param.obj_id}',timID = '${param.time_id}';
	    </script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/bsc/scripts/bsc_proj_index_rpt_result_statistics_ext.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/bsc/scripts/ComboBoxQuery.js"></script>
	</head>
  
  	<body>
	  	<!-- 导出Excel文件Form -->
	  	<form id="excelForm" name="excelForm" action="bscresult_exportResultDhtmlByCondExt.action" method="post" target="">
