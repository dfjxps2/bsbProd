 ...
 * 
 */
public interface PublicMeasureDao {
	/**
	 * 查询参数名
	 * @param measure_id
	 * @return
	 ...
	 * @throws Exception
	 */
	public void editEngMeasureFormula(Map<String, Object> paramMap)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<Map<String, Object>> listEngMeasure(Map<String, Object> paramMap)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<Map<String, Object>> getEngMeasureById(
	 ...
	 * @throws Exception
	 */
	public List<Map<String, Object>> listMeasureCalcDepend(
			Map<String, Object> paramMap) throws Exception;
